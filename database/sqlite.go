...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		`CREATE TABLE IF NOT EXISTS accounts (
			...
			proxy_provider_url TEXT DEFAULT '',
			proxy_scheme_default TEXT DEFAULT 'http',
			assigned_proxy_url TEXT DEFAULT '',
			proxy_last_switched_at TIMESTAMP NULL,
			proxy_next_rotation_at TIMESTAMP NULL,
		...
		`CREATE TABLE IF NOT EXISTS system_settings (
			...
			proxy_provider_url TEXT DEFAULT '',
			proxy_scheme_default TEXT DEFAULT 'http',
			auto_assign_proxy_if_missing INTEGER DEFAULT 1,
			switch_proxy_on_network_error INTEGER DEFAULT 1,
			proxy_rotation_hours INTEGER DEFAULT 24,
			disable_proxy_during_import INTEGER DEFAULT 1,
			...
			refresh_scan_enabled INTEGER DEFAULT 1,
			refresh_scan_interval_seconds INTEGER DEFAULT 120,
			refresh_pre_expire_seconds INTEGER DEFAULT 300,
			refresh_max_concurrency INTEGER DEFAULT 10,
			refresh_on_import_enabled INTEGER DEFAULT 1,
			refresh_on_import_concurrency INTEGER DEFAULT 10,
			usage_probe_enabled INTEGER DEFAULT 1,
			usage_probe_stale_after_seconds INTEGER DEFAULT 600,
			usage_probe_max_concurrency INTEGER DEFAULT 4,
			recovery_probe_enabled INTEGER DEFAULT 1,
			recovery_probe_min_interval_seconds INTEGER DEFAULT 1800,
			recovery_probe_max_concurrency INTEGER DEFAULT 2,
			allow_remote_migration INTEGER DEFAULT 0,
			cpa_sync_enabled INTEGER DEFAULT 0,
			cpa_base_url TEXT DEFAULT '',
			cpa_admin_key TEXT DEFAULT '',
			cpa_min_accounts INTEGER DEFAULT 0,
			cpa_max_accounts INTEGER DEFAULT 0,
			cpa_max_uploads_per_hour INTEGER DEFAULT 0,
			cpa_switch_after_uploads INTEGER DEFAULT 0,
			cpa_sync_interval_seconds INTEGER DEFAULT 300,
			mihomo_base_url TEXT DEFAULT '',
			mihomo_secret TEXT DEFAULT '',
			mihomo_strategy_group TEXT DEFAULT '',
			mihomo_delay_test_url TEXT DEFAULT '',
			mihomo_delay_timeout_ms INTEGER DEFAULT 5000
		);`,
		`CREATE TABLE IF NOT EXISTS cpa_sync_state (
			id INTEGER PRIMARY KEY DEFAULT 1 CHECK (id = 1),
			hour_bucket_start TIMESTAMP NULL,
			hourly_upload_count INTEGER DEFAULT 0,
			consecutive_upload_count INTEGER DEFAULT 0,
			last_switch_at TIMESTAMP NULL,
			last_run_at TIMESTAMP NULL,
			last_run_status TEXT DEFAULT '',
			last_run_summary TEXT DEFAULT '',
			last_error_summary TEXT DEFAULT '',
			current_mihomo_node TEXT DEFAULT '',
			last_cpa_account_count INTEGER DEFAULT 0,
			recent_actions TEXT DEFAULT '[]',
			cpa_test_ok INTEGER NULL,
			cpa_test_message TEXT DEFAULT '',
			cpa_test_http_status INTEGER NULL,
			cpa_tested_at TIMESTAMP NULL,
			cpa_test_details TEXT DEFAULT '{}',
			mihomo_test_ok INTEGER NULL,
			mihomo_test_message TEXT DEFAULT '',
			mihomo_test_http_status INTEGER NULL,
			mihomo_tested_at TIMESTAMP NULL,
			mihomo_test_details TEXT DEFAULT '{}'
		);`,
		`CREATE TABLE IF NOT EXISTS proxies (
			...
			scheme_default TEXT DEFAULT 'http',
			last_resolved_proxy_url TEXT DEFAULT '',
	...
	columns := []struct {
		...
		{"accounts", "proxy_mode", "TEXT DEFAULT 'inherit'"},
		{"accounts", "proxy_provider_url", "TEXT DEFAULT ''"},
		{"accounts", "proxy_scheme_default", "TEXT DEFAULT 'http'"},
		{"accounts", "assigned_proxy_url", "TEXT DEFAULT ''"},
		{"accounts", "proxy_last_switched_at", "TIMESTAMP NULL"},
		{"accounts", "proxy_next_rotation_at", "TIMESTAMP NULL"},
		{"accounts", "proxy_last_switch_reason", "TEXT DEFAULT ''"},
		{"accounts", "proxy_last_error", "TEXT DEFAULT ''"},
		...
		{"system_settings", "proxy_mode", "TEXT DEFAULT 'none'"},
		{"system_settings", "proxy_provider_url", "TEXT DEFAULT ''"},
		{"system_settings", "proxy_scheme_default", "TEXT DEFAULT 'http'"},
		{"system_settings", "auto_assign_proxy_if_missing", "INTEGER DEFAULT 1"},
		{"system_settings", "switch_proxy_on_network_error", "INTEGER DEFAULT 1"},
		{"system_settings", "proxy_rotation_hours", "INTEGER DEFAULT 24"},
		{"system_settings", "disable_proxy_during_import", "INTEGER DEFAULT 1"},
		...
		{"system_settings", "refresh_scan_enabled", "INTEGER DEFAULT 1"},
		{"system_settings", "refresh_scan_interval_seconds", "INTEGER DEFAULT 120"},
		{"system_settings", "refresh_pre_expire_seconds", "INTEGER DEFAULT 300"},
		{"system_settings", "refresh_max_concurrency", "INTEGER DEFAULT 10"},
		{"system_settings", "refresh_on_import_enabled", "INTEGER DEFAULT 1"},
		{"system_settings", "refresh_on_import_concurrency", "INTEGER DEFAULT 10"},
		{"system_settings", "usage_probe_enabled", "INTEGER DEFAULT 1"},
		{"system_settings", "usage_probe_stale_after_seconds", "INTEGER DEFAULT 600"},
		{"system_settings", "usage_probe_max_concurrency", "INTEGER DEFAULT 4"},
		{"system_settings", "recovery_probe_enabled", "INTEGER DEFAULT 1"},
		{"system_settings", "recovery_probe_min_interval_seconds", "INTEGER DEFAULT 1800"},
		{"system_settings", "recovery_probe_max_concurrency", "INTEGER DEFAULT 2"},
		{"system_settings", "allow_remote_migration", "INTEGER DEFAULT 0"},
		{"system_settings", "model_mapping", "TEXT DEFAULT '{}'"},
		{"system_settings", "cpa_sync_enabled", "INTEGER DEFAULT 0"},
		{"system_settings", "cpa_base_url", "TEXT DEFAULT ''"},
		{"system_settings", "cpa_admin_key", "TEXT DEFAULT ''"},
		{"system_settings", "cpa_min_accounts", "INTEGER DEFAULT 0"},
		{"system_settings", "cpa_max_accounts", "INTEGER DEFAULT 0"},
		{"system_settings", "cpa_max_uploads_per_hour", "INTEGER DEFAULT 0"},
		{"system_settings", "cpa_switch_after_uploads", "INTEGER DEFAULT 0"},
		{"system_settings", "cpa_sync_interval_seconds", "INTEGER DEFAULT 300"},
		{"system_settings", "mihomo_base_url", "TEXT DEFAULT ''"},
		{"system_settings", "mihomo_secret", "TEXT DEFAULT ''"},
		{"system_settings", "mihomo_strategy_group", "TEXT DEFAULT ''"},
		{"system_settings", "mihomo_delay_test_url", "TEXT DEFAULT ''"},
		{"system_settings", "mihomo_delay_timeout_ms", "INTEGER DEFAULT 5000"},
		{"cpa_sync_state", "hour_bucket_start", "TIMESTAMP NULL"},
		{"cpa_sync_state", "hourly_upload_count", "INTEGER DEFAULT 0"},
		{"cpa_sync_state", "consecutive_upload_count", "INTEGER DEFAULT 0"},
		{"cpa_sync_state", "last_switch_at", "TIMESTAMP NULL"},
		{"cpa_sync_state", "last_run_at", "TIMESTAMP NULL"},
		{"cpa_sync_state", "last_run_status", "TEXT DEFAULT ''"},
		{"cpa_sync_state", "last_run_summary", "TEXT DEFAULT ''"},
		{"cpa_sync_state", "last_error_summary", "TEXT DEFAULT ''"},
		{"cpa_sync_state", "current_mihomo_node", "TEXT DEFAULT ''"},
		{"cpa_sync_state", "last_cpa_account_count", "INTEGER DEFAULT 0"},
		{"cpa_sync_state", "recent_actions", "TEXT DEFAULT '[]'"},
		{"cpa_sync_state", "cpa_test_ok", "INTEGER NULL"},
		{"cpa_sync_state", "cpa_test_message", "TEXT DEFAULT ''"},
		{"cpa_sync_state", "cpa_test_http_status", "INTEGER NULL"},
		{"cpa_sync_state", "cpa_tested_at", "TIMESTAMP NULL"},
		{"cpa_sync_state", "cpa_test_details", "TEXT DEFAULT '{}'"},
		{"cpa_sync_state", "mihomo_test_ok", "INTEGER NULL"},
		{"cpa_sync_state", "mihomo_test_message", "TEXT DEFAULT ''"},
		{"cpa_sync_state", "mihomo_test_http_status", "INTEGER NULL"},
		{"cpa_sync_state", "mihomo_tested_at", "TIMESTAMP NULL"},
		{"cpa_sync_state", "mihomo_test_details", "TEXT DEFAULT '{}'"},
		{"accounts", "locked", "INTEGER DEFAULT 0"},

		{"proxies", "source_type", "TEXT DEFAULT 'static'"},
		{"proxies", "provider_url", "TEXT DEFAULT ''"},
		{"proxies", "scheme_default", "TEXT DEFAULT 'http'"},
		{"proxies", "last_resolved_proxy_url", "TEXT DEFAULT ''"},
		{"proxies", "last_resolved_at", "TIMESTAMP NULL"},
		{"proxies", "last_error", "TEXT DEFAULT ''"},
	...
	if _, err := db.conn.ExecContext(ctx, `INSERT OR IGNORE INTO cpa_sync_state (id) VALUES (1)`); err != nil {
		return err
	}
